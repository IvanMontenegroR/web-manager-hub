...
function ecoPayload(t) {
  return {
    ...
    // `issue` (Problema / situacion) se saco del tablero: se solapaba con las notas y
    // su contenido se migro a `notes`. La columna sigue en la DB pero ya no se escribe.
...
export const SEED_TASKS = [
  { section: 'Web', topic: 'Faltan videos mobile en home', action: 'Ivan needs to align with MRM.', owner: 'Ivan', status: 'Open', notes: 'Mobile videos are missing. (generic / cats / dogs)', priority: 'media' },
  { section: 'Web', topic: 'Cambiar food types latas/sobres', action: 'Change food type of the products listed here: https://purina.com.mx/purina/productos?food_type_filter%5B109%5D=109&food_type_filter%5B110%5D=110&page=0 to ones of these: Húmedo, Seco, Snacks.', owner: 'Ivan', status: 'On Hold', notes: 'There are 2 food types, latas and sobres, which are not actual food types and they would not be migrated', priority: 'alta' },
  { section: 'Web', topic: 'Corregir taxonomía Life stage', action: 'After migration, "Life stage" texonomy must be changed.', owner: 'Ivan', status: 'On Hold', notes: 'Product migrated with old content.', priority: 'media' },
  { section: 'Web', topic: 'Alcance: ¿migrar productos despublicados?', action: 'Define the scope.', owner: 'Ivan', status: 'Open', notes: 'Definition of migration scope. Unpublished products must be migrated?\n\nOnly published.', priority: 'alta' },
  { section: 'Web', topic: 'Acortar texto de Ingredientes', action: 'Text of the current content type - Ingrediente needs to be reviewed. It can be done before or after migration', owner: 'NBS', status: 'On Hold', notes: 'Current ingredient text is too long. EX: https://content-ef5-purina-latam-mx.pantheonsite.io/productos/campeonr-adultos-todos-los-tamanos', priority: 'baja' },
  { section: 'Web', topic: 'Imágenes de producto: fondo y tamaños', action: 'Product image must have transparent background. Images need to be replaced after migration.\nDetail page - Desk = 1136 x 1136 / Mob = 670 x 670\nCards = 540 x 540', owner: 'NBS', status: 'On Hold', notes: 'There are products with white background.', priority: 'media' },
  { section: 'Web', topic: 'Definir texto Plan C (reviews)', action: 'Ivan to be defined the text for plan C. MRM suggestion on column G', owner: 'Ivan', status: 'Done', notes: 'Text AI en la pagina de producto, Plan B ratings and reviews, y PLAN C (TEXT)?\n\n¿Ya probaste este producto? ¡Sé el primero en reseñarlo!\nEscribir la primera reseña', priority: 'baja' },
  { section: 'Web', topic: 'Identificar productos multi-sabor', action: 'After migration, it will be required to update each product, if needed, with main ingredient and related product (different flavour)', owner: 'NBS', status: 'On Hold', notes: 'Products with more than 1 flavour (or main ingredient) needs to be identified.', priority: 'media' },
  { section: 'Web', topic: 'Acortar descripciones de producto', action: 'Description needs to be reviewed after migration.', owner: 'NBS', status: 'On Hold', notes: 'Long descriptions. Example: https://purina.com.mx/dogchow/productos/adultos-medianos-grandes', priority: 'baja' },
  { section: 'CRM', topic: 'Faltan Engage Keys de MX', action: 'Ivan will follow up on this.', owner: 'Ivan', status: 'Open', notes: 'MX Engage Keys missing', priority: 'alta' },
  { section: 'Web', topic: 'Repoblar metadata Patasencasa', action: 'Content will not be migrated. It must be populated after migration.', owner: 'Hive', status: 'On Hold', notes: 'Migration of Patasencasa metadata', priority: 'media' },
  { section: 'Web', topic: 'Recibir lista de artículos Patasencasa', action: 'When are you going to receive this articles list?', owner: 'Ivan', status: 'Open', notes: 'List of articles from Patas en Casa to be migrated\n\nDue date: July 17', deadline: '2026-07-17', priority: 'alta' },
  { section: 'Web', topic: 'Alcance: ¿migrar artículos despublicados?', action: 'Define the scope.', owner: 'Ivan', status: 'Open', notes: 'Definition of migration scope. Unpublished articles must be migrated?\n\nOnly published.', priority: 'alta' },
  { section: 'Web', topic: 'Snacks no es marca (es componente)', action: 'Align with market', owner: 'Ivan', status: 'Open', notes: 'Snacks is not a brand but a component page', priority: 'media' },
  { section: 'Web', topic: 'Generar imágenes de marca (670×502)', action: 'Brand images needs to be generated (all brands). One image with size = 670 x 502', owner: 'Ivan', status: 'Open', notes: 'Images from the homepage', priority: 'media' },
  { section: 'Web', topic: 'Enviar guía de colores a F5', action: 'Send to F5 brand guide colors.', owner: 'Ivan / Gaby', status: 'Open', notes: 'Brand colors guide is missing. We have received only Proplan, Friskies and Fancy Feast.', priority: 'alta' },
  { section: 'Web', topic: 'Definir menú principal y submenús', action: 'Ivan will align with MX team.', owner: 'Ivan', status: 'Open', notes: 'Definition of main menu and sub menus CTAs. Including brand menu', priority: 'alta' },
  { section: 'Web', topic: 'Definir footer', action: 'Ivan will align with MX team.', owner: 'Ivan', status: 'Open', notes: 'Definition of footer', priority: 'media' },
  { section: 'Web', topic: 'Definir menú de usuario logueado', action: 'Check MRM proposal', owner: 'F5', status: 'Open', notes: 'Definition of user logged menu.', priority: 'media' },
  { section: 'Web', topic: 'Rediseñar Club Purina (no es componente)', action: 'Ivan will align with MRM', owner: 'Ivan', status: 'Open', notes: 'Page structure is totally different from a component page. https://www.figma.com/proto/esqBBkoMtEtiLSq23bNEfY/Purina---F5?node-id=4340-66404&t=E0fOZKhtY13qXAj5-0&scaling=scale-down&content-scaling=fixed&page-id=0%3A1', priority: 'media' },
  { section: 'Web', topic: 'Ajustar contenido de History al layout', action: 'Review of actual content', owner: 'Ivan', status: 'Open', notes: 'Actual content does not fit the layout.', priority: 'baja' },
  { section: 'Web', topic: 'Definir link de Sample request', action: 'Ivan will align with MX team.', owner: 'Ivan', status: 'Open', notes: 'Sample request link', priority: 'baja' },
  { section: 'Web', topic: 'Definir link de Vetline', action: 'Ivan will align with MX team.', owner: 'Ivan', status: 'Open', notes: 'Vetline link', priority: 'baja' },
  { section: 'Proceso', topic: 'Sync de contenido post-migración', action: 'Aignment date and how to proceed after content migrated', owner: 'Ivan + F5', status: 'Open', notes: 'Content synchronization after migration\n\nIvan + Helo will define a freeze period. Migration will happen after market architetural info file revision. Expected date: July 24', deadline: '2026-07-24', priority: 'alta' },
]
